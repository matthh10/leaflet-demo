...
The [{leaflet}](https://rstudio.github.io/leaflet/) package in R is useful for quickly creating interactive maps using free, open-source data [@leaflet].
...
## Extract geographic data {.smaller}
...
We can do this using the Scottish postcode directory, which can be loaded into the R environment using [{phslookups}](https://github.com/Public-Health-Scotland/phslookups).
:::
...
This loads in a `tibble` with columns on geographic metadata for each postcode in Scotland. 
...
## Add markers and popups {.smaller}
...
The slides and tutorial are available on GitHub: [matthh10/leaflet-demo](https://matthh10.github.io/leaflet-demo/)
